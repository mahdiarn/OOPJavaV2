...
/**
 *
 * @author Aulia Ichsan Rifyano + Aya
 */
public class Harimau{
    ...
    //Copy Constructor
    public Harimau(Harimau h) {
        this.animal = new Animal (h.animal);
    }
    
    public void Eat() {
        System.out.println("Porsi makanan harimau ini adalah " + animal.getWeight()*0.025 + " kg."); //To change body of generated methods, choose Tools | Templates.
    }

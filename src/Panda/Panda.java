...
public class Panda{
    ...
    //Copy Constructor
    public Panda(Panda p) {
        this.animal = new Animal (p.animal);
    }
    
    public void Eat() {
        System.out.println("Porsi makanan panda ini adalah " + animal.getWeight()*0.025 + " kg."); //To change body of generated methods, choose Tools | Templates.
    }
